...
RUN tar xzf jdk-8-linux-x64.tar.gz; mkdir -p /opt/java; mv jdk1.8.0_112 /opt/java; ln -s /opt/java/jdk1.8.0_112 /opt/java/latest; ln -s /opt/java/latest /opt/java/default

# JDK stripping
RUN rm -f /opt/java/jdk1.8.0_112/src.zip /opt/java/jdk1.8.0_112/javafx-src.zip
RUN rm -rf /opt/java/jdk1.8.0_112/lib/missioncontrol/ /opt/java/jdk1.8.0_112/lib/visualvm/ /opt/java/jdk1.8.0_112/db/
